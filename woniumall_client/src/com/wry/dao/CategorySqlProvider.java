...
import com.wry.domain.CategoryExample.Criteria;
import com.wry.domain.CategoryExample.Criterion;
...
public class CategorySqlProvider {
    public String countByExample(CategoryExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("mall_category");
    ...
    public String insertSelective(Category record) {
        ...
        if (record.getNavable() != null) {
            sql.VALUES("navable", "#{navable,jdbcType=CHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getNavable() != null) {
            sql.SET("navable = #{record.navable,jdbcType=CHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Category record) {
        ...
        if (record.getNavable() != null) {
            sql.SET("navable = #{navable,jdbcType=CHAR}");
        }
