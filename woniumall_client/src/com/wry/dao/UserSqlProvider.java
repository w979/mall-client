...
import com.wry.domain.UserExample.Criteria;
import com.wry.domain.UserExample.Criterion;
...
public class UserSqlProvider {
    ...
    public String insertSelective(User record) {
        ...
        if (record.getActivecode() != null) {
            sql.VALUES("activecode", "#{activecode,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getActivecode() != null) {
            sql.SET("activecode = #{record.activecode,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(User record) {
        ...
        if (record.getActivecode() != null) {
            sql.SET("activecode = #{activecode,jdbcType=VARCHAR}");
        }
