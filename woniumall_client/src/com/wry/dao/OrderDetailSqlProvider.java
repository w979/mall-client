...
import com.wry.domain.OrderDetailExample.Criteria;
import com.wry.domain.OrderDetailExample.Criterion;
...
public class OrderDetailSqlProvider {
    public String countByExample(OrderDetailExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("mall_order_item");
    ...
    public String deleteByExample(OrderDetailExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("mall_order_item");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String insertSelective(OrderDetail record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("mall_order_item");
